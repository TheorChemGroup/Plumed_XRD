#ifndef __PLUMED_tools_MAPconstants_h
#define __PLUMED_tools_MAPconstants_h
...
namespace PLMD {
	...
	*/
	constexpr double SFACTOR_1[94][9] = {{0.489918, 20.6593 , 0.262003, 7.74039 , 0.196767, 49.5519 , 0.049879 , 2.20159 , 0.001305},
	...
	constexpr double SFACTOR_2[8][4] = {{0.0, 0.0, 0.0, 0.0},
									 {0.52543, -3.43300,  4.80070, -2.54760}, 
									 {0.89463, -2.43660,  2.32500, -0.71949}, 
									 {1.25840, -1.94590,  1.30460, -0.04297}, 
									 {1.66720, -1.85560,  1.60440, -0.65981}, 
									 {1.70560, -1.56760,  1.18930, -0.42715}, 
									 {1.54940, -1.20190,  0.51064,  0.02472}, 
									 {1.30530, -0.83742, -0.16738,  0.47500}};
}
